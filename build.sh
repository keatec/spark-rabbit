...
docker run -e "LOG_LEVEL=debug" -p 8100:8080 -p 5683:5683 --volume /localStore/data:/usr/src/localCloud/spark-rabbit/data --link rabbit:rabbit -d --name sparkserver --hostname sparkserver keatec/spark-rabbit:nightly
